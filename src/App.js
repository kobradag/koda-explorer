...
import { getBlock } from './kobrad-api-client';
            ...
            <Navbar expand="md" bg="dark" variant="dark" sticky="top" id="navbar_top" className={location.pathname == "/" ? "" : "fixed-top"}>
              <Container id="navbar-container" fluid>
                  ...
                  <Navbar.Brand >
                    <Link to="/">
                      <div className="navbar-brand">
                        ...
                        <div className="navbar-brand-text text-start">KODA<br />EXPLORER</div>
                      </div>
                    </Link>
                  </Navbar.Brand>
                </div>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                  ...
                  <div className='ms-auto navbar-price'>${price} <span className="text-light">/ KODA</span></div>
                </Navbar.Collapse>
              </Container>
            </Navbar>
                ...
                <Row><Col xs={12}>
                  <Form onSubmit={search} className="">
                    <InputGroup className="mt-4 mb-4 search-box-group">
                      <Form.Control className="d-inline-block bg-light text-dark shadow-none" name="searchbox" id="search-box-high" type="text" placeholder="Search for 
:address or block" />
