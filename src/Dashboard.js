...
import KodaInfoBox from './components/KodaInfoBox';
...
function Dashboard() {
  ...
  const [address, setAddress] = useState("kobra:");
            ...
            <Col xs={11}>
              <Form onSubmit={search}>
                <InputGroup className="ms-md-5 mt-5 me-5 dashboard-search-box">
                  <Form.Control className="bg-light text-dark shadow-none" name="searchInput" type="text" placeholder="Search for kobra:address or block" />
      ...
      <div className="row2">
        <Container className="secondRow webpage" fluid>
          <Row>
            ...
            <Col sm={12} md={6} xl={3}><div className="infoBox"><KodaInfoBox /></div></Col>
